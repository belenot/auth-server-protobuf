...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x32, 0xaa, 0x02, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x33, 0x0a,
	...
	0x73, 0x65, 0x12, 0x33, 0x0a, 0x06, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x12, 0x13, 0x2e, 0x61,
	0x75, 0x74, 0x68, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x14, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x07, 0x53, 0x69, 0x67, 0x6e, 0x6f,
	0x75, 0x74, 0x12, 0x14, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x6f, 0x75,
	...
	0x65, 0x42, 0x12, 0x5a, 0x10, 0x62, 0x65, 0x6c, 0x65, 0x6e, 0x6f, 0x74, 0x2e, 0x66, 0x75, 0x6e,
...
var file_auth_auth_proto_goTypes = []interface{}{
	...
	nil,                          // 10: auth.UserInfoResponse.AttrsEntry
}
var file_auth_auth_proto_depIdxs = []int32{
	10, // 0: auth.UserInfoResponse.attrs:type_name -> auth.UserInfoResponse.AttrsEntry
	2,  // 1: auth.Auth.Signup:input_type -> auth.SignupRequest
	0,  // 2: auth.Auth.Signin:input_type -> auth.SigninRequest
	4,  // 3: auth.Auth.Signout:input_type -> auth.SignoutRequest
	6,  // 4: auth.Auth.RefreshToken:input_type -> auth.RefreshTokenRequest
	8,  // 5: auth.Auth.UserInfo:input_type -> auth.UserInfoRequest
	3,  // 6: auth.Auth.Signup:output_type -> auth.SignupResponse
	1,  // 7: auth.Auth.Signin:output_type -> auth.SigninResponse
	5,  // 8: auth.Auth.Signout:output_type -> auth.SignoutResponse
	7,  // 9: auth.Auth.RefreshToken:output_type -> auth.RefreshTokenResponse
	9,  // 10: auth.Auth.UserInfo:output_type -> auth.UserInfoResponse
